...
export function NavigationMenuDemo() {
    return (
        <div className="border border-b-border rounded-lg bg-background  bg-opacity-50 ">
            <NavigationMenu className="min-w-full justify-around">
                ...
                <NavigationMenuList>
                    <div className="flex py-2 gap-3 justify-end items-center">
